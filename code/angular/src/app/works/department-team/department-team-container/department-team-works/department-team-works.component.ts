...
@Component({
  selector: 'app-department-team-works',
  templateUrl: './department-team-works.component.html',
  styleUrls: ['./department-team-works.component.scss']
})
export class DepartmentTeamWorksComponent implements OnInit {
