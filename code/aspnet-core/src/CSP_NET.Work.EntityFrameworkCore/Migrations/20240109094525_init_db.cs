...
namespace CSP_NET.Work.Migrations
{
    /// <inheritdoc />
    public partial class init_db : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AbpOrganizationUnitTypes", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Keyword = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("SYS_C435324523500", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CSP_CAT_Category", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "CSP_CAT_DefineVersions",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CSP_CAT_DefineVersions", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OrganizationUnitTypeId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AbpOrganizationUnits_AbpOrganizationUnitTypes_OrganizationUnitTypeId",
                        column: x => x.OrganizationUnitTypeId,
                        principalTable: "AbpOrganizationUnitTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AbpOrganizationUnits_Level",
                table: "AbpOrganizationUnits",
                column: "Level");

            migrationBuilder.CreateIndex(
                name: "IX_AbpOrganizationUnits_OrganizationUnitTypeId",
                table: "AbpOrganizationUnits",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AbpOrganizationUnitTypes_IsActive",
                table: "AbpOrganizationUnitTypes",
                column: "IsActive");

            migrationBuilder.CreateIndex(
                name: "IX_AbpOrganizationUnitTypes_Name",
                table: "AbpOrganizationUnitTypes",
                column: "Name");
